...
from csg_vl.model.builder import load_pretrained_model
from csg_vl.util.mm_utils import get_model_name_from_path, tokenizer_image_token
from csg_vl.constants import IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN
from csg_vl.conversation import conv_templates
...
def call_csg_vl_engine_df(args, sample, model, tokenizer=None, processor=None):
...
def main():
    ...
    print('csg_vl_initializing...')
    processor = None
    call_model_engine = call_csg_vl_engine_df
