...
from csg_vl.conversation import (default_conversation, conv_templates, SeparatorStyle)
from csg_vl.constants import LOGDIR
from csg_vl.util.utils import (build_logger, server_error_msg, violates_moderation, moderation_msg)

logger = build_logger("gradio_web_server", "gradio_web_server.log")

headers = {"User-Agent": "CSG_vl Client"}
...
title_markdown = ("""
# 🐰 CSG-vl: A family of lightweight multimodal models

[📖[Technical report](https://arxiv.org/abs/2402.11530)] | [🏠[Code](https://github.com/BAAI-DCAI/csg_vl)] | [🤗[Model](https://huggingface.co/BAAI/csg_vl-v1_0-3B)]
...
def build_demo(embed_mode):
    ...
    with gr.Blocks(title="csg_vl", theme=gr.themes.Default(primary_hue="blue", secondary_hue="lime"),
        ...
        with gr.Row():
            ...
            with gr.Column(scale=8):
                chatbot = gr.Chatbot(elem_id="chatbot", label="csg_vl Chatbot",
